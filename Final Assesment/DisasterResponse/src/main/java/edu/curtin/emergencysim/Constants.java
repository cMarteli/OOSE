...
public final class Constants
{
    ...
    //fire
    public static final int FIRE_LOW_TO_HIGH_TIME = 200; //time(seconds) it takes for a low intensity fire to turn high intensity
    public static final int FIRE_LOW_CLEANP_TIME = 100; //time(seconds) to actively extinguish a low intensity fire
    public static final int FIRE_HIGH_TO_LOW_TIME = 300; //time(seconds) it takes for a high intensity fire to turn low intensity
    ...
    //flood
    public static final int FLOOD_END_TIME = 200; //time(seconds) for a flood to dissipate on it's own
    ...
    //chemical
    public static final int CHEM_CLEANUP_TIME = 200; //time(seconds) to actively clean a chemical spill
